...
const LandingPage = () => {
  ...
  return (
    <div className=" flex flex-col xl:flex-row h-screen mx-4 md:px-16 xl:items-center  justify-evenly ">
      ...
      <div className="fixed  delay-[1000ms] inset-y-0 right-0 w-1/2 duration-[4000ms] animate-slide  bg-gradient-to-l from-sky-100 to-emerald-300 opacity-40 blur"></div>
      <div className="fixed  delay-[4000ms] inset-y-0 left-0 w-full duration-[5000ms] animate-slide  bg-gradient-to-l from-emerald-300 to-sky-300 opacity-40 blur"></div>
      <div className="fixed  delay-[3000ms] inset-y-0 left-0 w-1/2 duration-[4000ms] animate-slide  bg-gradient-to-l from-sky-300 to-sky-100 opacity-40 blur"></div>
    </div>
  );
};
